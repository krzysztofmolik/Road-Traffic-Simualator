    ...
    public class PrimitiveBatch : IPrimitiveBatch
    {
        ...
        public void UpdateBasicEffect()
        {
            ...
            this.basicEffect.Projection =
                Matrix.CreateOrthographicOffCenter( 0, this.device.Viewport.Width,
                                                    this.device.Viewport.Height, 0,
                                                    0, 1 );
                              }
        ...
        {
            this.device.DeviceReset -= this.OnDeviceReset;
        ...
        public void End()
        {
            ...
            // DrawTriangeList whatever the user wanted us to draw
            Flush();
