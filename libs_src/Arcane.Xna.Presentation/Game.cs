...
//                this.targetElapsedTime = TimeSpan.FromTicks( ( long ) 0x28b0a );
        ...
        private void HookDeviceEvents()
        {
            ...
            {
                this.graphicsDeviceService.DeviceCreated += this.DeviceCreated;
                this.graphicsDeviceService.DeviceResetting += this.DeviceResetting;
                this.graphicsDeviceService.DeviceReset += this.DeviceReset;
                this.graphicsDeviceService.DeviceDisposing += this.DeviceDisposing;
            }
        }
